...
INSERT INTO ohrm_display_field (display_field_id, report_group_id, name, label, field_alias, is_sortable, sort_order, sort_field, element_type, element_property, width, is_exportable, text_alignment_style, is_value_list, display_field_group_id, default_value, is_encrypted, is_meta) VALUES
    (1, 1, 'ohrm_project.name', 'Project Name',                'projectname',  0, null, null, 'label', '<xml><getter>projectname</getter></xml>', 200, '0', null, 0, null, null, 0, 0),
    (2, 1, 'ohrm_project_activity.name', 'Activity Name',      'activityname', 0, null, null, 'link', '<xml><labelGetter>activityname</labelGetter><placeholderGetters><id>activity_id</id><total>totalduration</total><projectId>projectId</projectId><from>fromDate</from><to>toDate</to><approved>onlyIncludeApprovedTimesheets</approved></placeholderGetters><urlPattern>../../displayProjectActivityDetailsReport?reportId=3#activityId={id}#total={total}#from={from}#to={to}#projectId={projectId}#onlyIncludeApprovedTimesheets={approved}</urlPattern></xml>', 200, '0', null, 0, null, null, 0, 0),
    (3, 1, 'ohrm_project_activity.project_id', 'Project Id',    null, 0, null, null, 'label', '<xml><getter>project_id</getter></xml>', 75, '0', 'right', 0, null, null, 0, 1),
    (4, 1, 'ohrm_project_activity.activity_id', 'Activity Id',  null,  0, null, null, 'label', '<xml><getter>activity_id</getter></xml>', 75, '0', 'right', 0, null, null, 0, 1),
    (5, 1, 'ohrm_timesheet_item.duration', 'Time (hours)',       null, 0, null, null, 'label', '<xml><getter>duration</getter></xml>', 75, '0', 'right', 0, null, null, 0, 0),
    (6, 1, 'hs_hr_employee.emp_firstname', 'Employee First Name', null,  0, null, null, 'label', '<xml><getter>emp_firstname</getter></xml>', 200, '0', null, 0, null, null, 0, 0),
    (7, 1, 'hs_hr_employee.emp_lastname', 'Employee Last Name',   null, 0, null, null, 'label', '<xml><getter>emp_lastname</getter></xml>', 200, '0', null, 0, null, null, 0, 0),
    (8, 1, 'ohrm_project_activity.name', 'Activity Name',       'activityname', 0, null, null, 'label', '<xml><getter>activityname</getter></xml>', 200, '0', null, 0, null, null, 0, 0),
    (9, 3, 'hs_hr_employee.employee_id', 'Employee Id',          'employeeId',  0, null, null, 'label', '<xml><getter>employeeId</getter></xml>', 100, '0', null, 0, 1, '---', 0, 0),
    (10, 3, 'hs_hr_employee.emp_lastname', 'Employee Last Name',  'employeeLastname',  0, null, null, 'label', '<xml><getter>employeeLastname</getter></xml>', 200, '0', null, 0, 1, '---', 0, 0),
    (11, 3, 'hs_hr_employee.emp_firstname', 'Employee First Name','employeeFirstname',  0, null, null, 'label', '<xml><getter>employeeFirstname</getter></xml>', 200, '0', null, 0, 1, '---', 0, 0),
    (12, 3, 'hs_hr_employee.emp_middle_name', 'Employee Middle Name', 'employeeMiddlename',  0, null, null, 'label', '<xml><getter>employeeMiddlename</getter></xml>', 200, '0', null, 0, 1, '---', 0, 0),
    (13, 3, 'hs_hr_employee.emp_birthday', 'Date of Birth',           'empBirthday',  0, null, null, 'labelDate', '<xml><getter>empBirthday</getter></xml>', 100, '0', null, 0, 1, '---', 0, 0),
    (14, 3, 'ohrm_nationality.name', 'Nationality',              'nationality',  0, null, null, 'label', '<xml><getter>nationality</getter></xml>', 200, '0', null, 0, 1, '---', 0, 0),
    (15, 3, 'CASE hs_hr_employee.emp_gender WHEN 1 THEN "Male" WHEN 2 THEN "Female" WHEN 3 THEN "Other" END', 'Gender', 'empGender',  0, null, null, 'label', '<xml><getter>empGender</getter></xml>', 80, '0', null, 0, 1, '---', 0, 0),
    (17, 3, 'hs_hr_employee.emp_marital_status', 'Marital Status',    'maritalStatus',  0, null, null, 'label', '<xml><getter>maritalStatus</getter></xml>', 100, '0', null, 0, 1, '---', 0, 0),
    (18, 3, 'hs_hr_employee.emp_dri_lice_num', 'Driver License Number', 'driversLicenseNumber',  0, null, null, 'label', '<xml><getter>driversLicenseNumber</getter></xml>', 240, '0', null, 0, 1, '---', 0, 0),
    (19, 3, 'hs_hr_employee.emp_dri_lice_exp_date', 'License Expiry Date', 'licenseExpiryDate',  0, null, null, 'labelDate', '<xml><getter>licenseExpiryDate</getter></xml>', 135, '0', null, 0, 1, '---', 0, 0),
    (20, 3, 'CONCAT_WS(", ", NULLIF(hs_hr_employee.emp_street1, ""), NULLIF(hs_hr_employee.emp_street2, ""), NULLIF(hs_hr_employee.city_code, ""), NULLIF(hs_hr_employee.provin_code,""), NULLIF(hs_hr_employee.emp_zipcode,""), NULLIF(hs_hr_country.cou_name,""))', 'Address', 'address',  0, null, null, 'label', '<xml><getter>address</getter></xml>', 200, '0', null, 0, 2, '---', 0, 0),
    (21, 3, 'hs_hr_employee.emp_hm_telephone', 'Home Telephone',  'homeTelephone',  0, null, null, 'label', '<xml><getter>homeTelephone</getter></xml>', 130, '0', null, 0, 2, '---', 0, 0),
    (22, 3, 'hs_hr_employee.emp_mobile', 'Mobile', 'mobile',  0, null, null, 'label', '<xml><getter>mobile</getter></xml>', 100, '0', null, 0, 2, '---', 0, 0),
    (23, 3, 'hs_hr_employee.emp_work_telephone', 'Work Telephone', 'workTelephone',  0, null, null, 'label', '<xml><getter>workTelephone</getter></xml>', 100, '0', null, 0, 2, '---', 0, 0),
    (24, 3, 'hs_hr_employee.emp_work_email', 'Work Email',         'workEmail',  0, null, null, 'label', '<xml><getter>workEmail</getter></xml>', 200, '0', null, 0, 2, '---', 0, 0),
    (25, 3, 'hs_hr_employee.emp_oth_email', 'Other Email',         'otherEmail',  0, null, null, 'label', '<xml><getter>otherEmail</getter></xml>', 200, '0', null, 0, 2, '---', 0, 0),
    (26, 3, 'hs_hr_emp_emergency_contacts.eec_name', 'Name', 'ecname',  0, null, null, 'label', '<xml><getter>ecname</getter></xml>', 200, '0', null, 1, 3, '---', 0, 0),
    (27, 3, 'hs_hr_emp_emergency_contacts.eec_home_no', 'Home Telephone', 'ecHomeTelephone',  0, null, null, 'label', '<xml><getter>ecHomeTelephone</getter></xml>', 130, '0', null, 1, 3, '---', 0, 0),
    (28, 3, 'hs_hr_emp_emergency_contacts.eec_office_no', 'Work Telephone', 'ecWorkTelephone',  0, null, null, 'label', '<xml><getter>ecWorkTelephone</getter></xml>', 100, '0', null, 1, 3, '---', 0, 0),
    (29, 3, 'hs_hr_emp_emergency_contacts.eec_relationship', 'Relationship', 'ecRelationship',  0, null, null, 'label', '<xml><getter>ecRelationship</getter></xml>', 200, '0', null, 1, 3, '---', 0, 0),
    (30, 3, 'hs_hr_emp_emergency_contacts.eec_mobile_no', 'Mobile', 'ecMobile',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 3, '---', 0, 0),
    (31, 3, 'hs_hr_emp_dependents.ed_name', 'Name', 'dependentName',  0, null, null, 'label', '<xml><getter>dependentName</getter></xml>', 200, '0', null, 1, 4, '---', 0, 0),
    (32, 3, 'IF (hs_hr_emp_dependents.ed_relationship_type = ''other'', hs_hr_emp_dependents.ed_relationship, hs_hr_emp_dependents.ed_relationship_type)', 'Relationship', 'dependentRelationship',  0, null, null, 'label', '<xml><getter>dependentRelationship</getter></xml>', 200, '0', null, 1, 4, '---', 0, 0),
    (33, 3, 'hs_hr_emp_dependents.ed_date_of_birth', 'Date of Birth', 'dependentDateofBirth',  0, null, null, 'labelDate', '<xml><getter>dependentDateofBirth</getter></xml>', 100, '0', null, 1, 4, '---', 0, 0),
    (35, 3, 'ohrm_membership.name', 'Membership', 'name',  0, null, null, 'label', '<xml><getter>name</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (36, 3, 'hs_hr_emp_member_detail.ememb_subscript_ownership', 'Subscription Paid By', 'subscriptionPaidBy',  0, null, null, 'label', '<xml><getter>subscriptionPaidBy</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (37, 3, 'hs_hr_emp_member_detail.ememb_subscript_amount', 'Subscription Amount', 'subscriptionAmount',  0, null, null, 'label', '<xml><getter>subscriptionAmount</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (38, 3, 'hs_hr_emp_member_detail.ememb_subs_currency', 'Currency', 'membershipCurrency',  0, null, null, 'label', '<xml><getter>membershipCurrency</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (39, 3, 'hs_hr_emp_member_detail.ememb_commence_date', 'Subscription Commence Date', 'subscriptionCommenceDate',  0, null, null, 'labelDate', '<xml><getter>subscriptionCommenceDate</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (40, 3, 'hs_hr_emp_member_detail.ememb_renewal_date', 'Subscription Renewal Date', 'subscriptionRenewalDate',  0, null, null, 'labelDate', '<xml><getter>subscriptionRenewalDate</getter></xml>', 200, '0', null, 1, 15, '---', 0, 0),
    (41, 3, 'hs_hr_emp_work_experience.eexp_employer', 'Company', 'expCompany',  0, null, null, 'label', '<xml><getter>expCompany</getter></xml>', 200, '0', null, 1, 10, '---', 0, 0),
    (42, 3, 'hs_hr_emp_work_experience.eexp_jobtit', 'Job Title', 'expJobTitle',  0, null, null, 'label', '<xml><getter>expJobTitle</getter></xml>', 200, '0', null, 1, 10, '---', 0, 0),
    (43, 3, 'hs_hr_emp_work_experience.eexp_from_date', 'From', 'expFrom',  0, null, null, 'labelDate', '<xml><getter>expFrom</getter></xml>', 100, '0', null, 1, 10, '---', 0, 0),
    (44, 3, 'hs_hr_emp_work_experience.eexp_to_date', 'To', 'expTo',  0, null, null, 'labelDate', '<xml><getter>expTo</getter></xml>', 100, '0', null, 1, 10, '---', 0, 0),
    (45, 3, 'hs_hr_emp_work_experience.eexp_comments', 'Comment', 'expComment',  0, null, null, 'label', '<xml><getter>expComment</getter></xml>', 200, '0', null, 1, 10, '---', 0, 0),
    (47, 3, 'ohrm_education.name', 'Level', 'eduProgram',  0, null, null, 'label', '<xml><getter>eduProgram</getter></xml>', 200, '0', null, 1, 11, '---', 0, 0),
    (48, 3, 'ohrm_emp_education.year', 'Year', 'eduYear',  0, null, null, 'label', '<xml><getter>eduYear</getter></xml>', 100, '0', null, 1, 11, '---', 0, 0),
    (49, 3, 'ohrm_emp_education.score', 'Score', 'eduGPAOrScore',  0, null, null, 'label', '<xml><getter>eduGPAOrScore</getter></xml>', 80, '0', null, 1, 11, '---', 0, 0),
    (52, 3, 'ohrm_skill.name', 'Skill', 'skill',  0, null, null, 'label', '<xml><getter>skill</getter></xml>', 200, '0', null, 1, 12, '---', 0, 0),
    (53, 3, 'hs_hr_emp_skill.years_of_exp', 'Years of Experience', 'skillYearsOfExperience',  0, null, null, 'label', '<xml><getter>skillYearsOfExperience</getter></xml>', 135, '0', null, 1, 12, '---', 0, 0),
    (54, 3, 'hs_hr_emp_skill.comments', 'Comments', 'skillComments',  0, null, null, 'label', '<xml><getter>skillComments</getter></xml>', 200, '0', null, 1, 12, '---', 0, 0),
    (55, 3, 'ohrm_language.name', 'Language', 'langName',  0, null, null, 'label', '<xml><getter>langName</getter></xml>', 200, '0', null, 1, 13, '---', 0, 0),
    (57, 3, 'CASE hs_hr_emp_language.competency WHEN 1 THEN "Poor" WHEN 2 THEN "Basic" WHEN 3 THEN "Good" WHEN 4 THEN "Mother Tongue" END', 'Competency', 'langCompetency',  0, null, null, 'label', '<xml><getter>langCompetency</getter></xml>', 130, '0', null, 1, 13, '---', 0, 0),
    (58, 3, 'hs_hr_emp_language.comments', 'Comments', 'langComments',  0, null, null, 'label', '<xml><getter>langComments</getter></xml>', 200, '0', null, 1, 13, '---', 0, 0),
    (59, 3, 'ohrm_license.name', 'License Type', 'empLicenseType',  0, null, null, 'label', '<xml><getter>empLicenseType</getter></xml>', 200, '0', null, 1, 14, '---', 0, 0),
    (60, 3, 'ohrm_emp_license.license_issued_date', 'Issued Date', 'empLicenseIssuedDate',  0, null, null, 'labelDate', '<xml><getter>empLicenseIssuedDate</getter></xml>', 100, '0', null, 1, 14, '---', 0, 0),
    (61, 3, 'ohrm_emp_license.license_expiry_date', 'Expiry Date', 'empLicenseExpiryDate',  0, null, null, 'labelDate', '<xml><getter>empLicenseExpiryDate</getter></xml>', 100, '0', null, 1, 14, '---', 0, 0),
    (62, 3, 'supervisor.emp_firstname', 'First Name', 'supervisorFirstName',  0, null, null, 'label', '<xml><getter>supervisorFirstName</getter></xml>', 200, '0', null, 1, 9, '---', 0, 0),
    (63, 3, 'subordinate.emp_firstname', 'First Name', 'subordinateFirstName',  0, null, null, 'label', '<xml><getter>subordinateFirstName</getter></xml>', 200, '0', null, 1, 8, '---', 0, 0),
    (64, 3, 'supervisor.emp_lastname', 'Last Name', 'supervisorLastName',  0, null, null, 'label', '<xml><getter>supervisorLastName</getter></xml>', 200, '0', null, 1, 9, '---', 0, 0),
    (65, 3, 'ohrm_pay_grade.name', 'Pay Grade', 'salPayGrade',  0, null, null, 'label', '<xml><getter>salPayGrade</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (66, 3, 'hs_hr_emp_basicsalary.salary_component', 'Salary Component', 'salSalaryComponent',  0, null, null, 'label', '<xml><getter>salSalaryComponent</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (67, 3, 'hs_hr_emp_basicsalary.ebsal_basic_salary', 'Amount', 'salAmount',  0, null, null, 'label', '<xml><getter>salAmount</getter></xml>', 200, '0', null, 1, 7, '---', 1, 0),
    (68, 3, 'hs_hr_emp_basicsalary.comments', 'Comments', 'salComments',  0, null, null, 'label', '<xml><getter>salComments</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (69, 3, 'hs_hr_payperiod.payperiod_name', 'Pay Frequency', 'salPayFrequency',  0, null, null, 'label', '<xml><getter>salPayFrequency</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (70, 3, 'hs_hr_currency_type.currency_name', 'Currency', 'salCurrency',  0, null, null, 'label', '<xml><getter>salCurrency</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (71, 3, 'hs_hr_emp_directdebit.dd_account', 'Direct Deposit Account Number', 'ddAccountNumber',  0, null, null, 'label', '<xml><getter>ddAccountNumber</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (72, 3, 'hs_hr_emp_directdebit.dd_account_type', 'Direct Deposit Account Type', 'ddAccountType',  0, null, null, 'label', '<xml><getter>ddAccountType</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (73, 3, 'hs_hr_emp_directdebit.dd_routing_num', 'Direct Deposit Routing Number', 'ddRoutingNumber',  0, null, null, 'label', '<xml><getter>ddRoutingNumber</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (74, 3, 'hs_hr_emp_directdebit.dd_amount', 'Direct Deposit Amount', 'ddAmount',  0, null, null, 'label', '<xml><getter>ddAmount</getter></xml>', 200, '0', null, 1, 7, '---', 0, 0),
    (75, 3, 'hs_hr_emp_contract_extend.econ_extend_start_date', 'Contract Start Date', 'empContStartDate',  0, null, null, 'labelDate', '<xml><getter>empContStartDate</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (76, 3, 'hs_hr_emp_contract_extend.econ_extend_end_date', 'Contract End Date', 'empContEndDate',  0, null, null, 'labelDate', '<xml><getter>empContEndDate</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (77, 3, 'ohrm_job_title.job_title', 'Job Title', 'empJobTitle',  0, null, null, 'label', '<xml><getter>empJobTitle</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (78, 3, 'ohrm_employment_status.name', 'Employment Status', 'empEmploymentStatus',  0, null, null, 'label', '<xml><getter>empEmploymentStatus</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (80, 3, 'ohrm_job_category.name', 'Job Category', 'empJobCategory',  0, null, null, 'label', '<xml><getter>empJobCategory</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (81, 3, 'hs_hr_employee.joined_date', 'Joined Date', 'empJoinedDate',  0, null, null, 'labelDate', '<xml><getter>empJoinedDate</getter></xml>', 100, '0', null, 1, 6, '---', 0, 0),
    (82, 3, 'ohrm_subunit.name', 'Sub Unit', 'empSubUnit',  0, null, null, 'label', '<xml><getter>empSubUnit</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (83, 3, 'ohrm_location.name', 'Location', 'empLocation',  0, null, null, 'label', '<xml><getter>empLocation</getter></xml>', 200, '0', null, 1, 6, '---', 0, 0),
    (84, 3, 'hs_hr_emp_passport.ep_passport_num', 'Number', 'empPassportNo',  0, null, null, 'label', '<xml><getter>empPassportNo</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (85, 3, 'hs_hr_emp_passport.ep_passportissueddate', 'Issued Date', 'empPassportIssuedDate',  0, null, null, 'labelDate', '<xml><getter>empPassportIssuedDate</getter></xml>', 100, '0', null, 1, 5, '---', 0, 0),
    (86, 3, 'hs_hr_emp_passport.ep_passportexpiredate', 'Expiry Date', 'empPassportExpiryDate',  0, null, null, 'labelDate', '<xml><getter>empPassportExpiryDate</getter></xml>', 100, '0', null, 1, 5, '---', 0, 0),
    (87, 3, 'hs_hr_emp_passport.ep_i9_status', 'Eligibility Status', 'empPassportEligibleStatus',  0, null, null, 'label', '<xml><getter>empPassportEligibleStatus</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (88, 3, 'hs_hr_emp_passport.cou_code', 'Issued By', 'empPassportIssuedBy',  0, null, null, 'label', '<xml><getter>empPassportIssuedBy</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (89, 3, 'hs_hr_emp_passport.ep_i9_review_date', 'Eligibility Review Date', 'empPassportEligibleReviewDate',  0, null, null, 'labelDate', '<xml><getter>empPassportEligibleReviewDate</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (90, 3, 'hs_hr_emp_passport.ep_comments', 'Comments', 'empPassportComments',  0, null, null, 'label', '<xml><getter>empPassportComments</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (91, 3, 'subordinate.emp_lastname', 'Last Name', 'subordinateLastName',  0, null, null, 'label', '<xml><getter>subordinateLastName</getter></xml>', 200, '0', null, 1, 8, '---', 0, 0),
    (92, 3, 'CASE hs_hr_emp_language.fluency WHEN 1 THEN "Writing" WHEN 2 THEN "Speaking" WHEN 3 THEN "Reading" END', 'Fluency', 'langFluency',  0, null, null, 'label', '<xml><getter>langFluency</getter></xml>', 200, '0', null, 1, 13, '---', 0, 0),
    (93, 3, 'supervisor_reporting_method.reporting_method_name', 'Reporting Method', 'supReportingMethod',  0, null, null, 'label', '<xml><getter>supReportingMethod</getter></xml>', 200, '0', null, 1, 9, '---', 0, 0),
    (94, 3, 'subordinate_reporting_method.reporting_method_name', 'Reporting Method', 'subReportingMethod',  0, null, null, 'label', '<xml><getter>subReportingMethod</getter></xml>', 200, '0', null, 1, 8, '---', 0, 0),
    (95, 3, 'CASE hs_hr_emp_passport.ep_passport_type_flg WHEN 1 THEN "Passport" WHEN 2 THEN "Visa" END', 'Document Type', 'documentType',  0, null, null, 'label', '<xml><getter>documentType</getter></xml>', 200, '0', null, 1, 5, '---', 0, 0),
    (97, 3, 'hs_hr_employee.emp_other_id', 'Other Id', 'otherId', 0, null, null, 'label', '<xml><getter>otherId</getter></xml>', 100, '0', null, 0, 1, '---', 0, 0),
    (98, 3, 'hs_hr_emp_emergency_contacts.eec_seqno', 'ecSeqNo', 'ecSeqNo',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 3, '---', 0, 1),
    (99, 3, 'hs_hr_emp_dependents.ed_seqno', 'SeqNo', 'edSeqNo',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 4, '---', 0, 1),
    (100, 3, 'hs_hr_emp_passport.ep_seqno', 'SeqNo', 'epSeqNo',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 5, '---', 0, 1),
    (101, 3, 'hs_hr_emp_basicsalary.id', 'salaryId', 'salaryId',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 7, '---', 0, 1),
    (102, 3, 'subordinate.emp_number', 'subordinateId', 'subordinateId',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 8, '---', 0, 1),
    (103, 3, 'supervisor.emp_number', 'supervisorId', 'supervisorId',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 9, '---', 0, 1),
    (104, 3, 'hs_hr_emp_work_experience.eexp_seqno', 'workExpSeqNo', 'workExpSeqNo',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 10, '---', 0, 1),
    (105, 3, 'ohrm_emp_education.education_id', 'empEduCode', 'empEduCode',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 11, '---', 0, 1),
    (106, 3, 'hs_hr_emp_skill.skill_id', 'empSkillCode', 'empSkillCode',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 12, '---', 0, 1),
    (107, 3, 'hs_hr_emp_language.lang_id', 'empLangCode', 'empLangCode',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 13, '---', 0, 1),
    (108, 3, 'hs_hr_emp_language.fluency', 'empLangType', 'empLangType',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 13, '---', 0, 1),
    (109, 3, 'ohrm_emp_license.license_id', 'empLicenseCode', 'empLicenseCode',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 14, '---', 0, 1),
    (110, 3, 'hs_hr_emp_member_detail.membship_code', 'membershipCode', 'membershipCode',  0, null, null, 'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, 1, 15, '---', 0, 1),
    (112, 3, 'ROUND(DATEDIFF(hs_hr_emp_work_experience.eexp_to_date, hs_hr_emp_work_experience.eexp_from_date)/365,1)', 'Duration', 'expDuration',  0, null, null, 'label', '<xml><getter>expDuration</getter></xml>', 100, '0', null, 1, 10, '---', 0, 0),
    (113, 3, 'ohrm_emp_termination.termination_date', 'Termination Date', 'terminationDate',  0, null, null, 'labelDate', '<xml><getter>terminationDate</getter></xml>', 100, '0', null, 1, 6, '---', 0, 0),
    (114, 3, 'ohrm_emp_termination_reason.name', 'Termination Reason', 'terminationReason',  0, null, null, 'label', '<xml><getter>terminationReason</getter></xml>', 100, '0', null, 1, 6, '---', 0, 0),
    (115, 3, 'ohrm_emp_education.institute', 'Institute', 'getInstitute',  0, null, null, 'label', '<xml><getter>getInstitute</getter></xml>', 80, '0', null, 1, 11, '---', 0, 0),
    (116, 3, 'ohrm_emp_education.major', 'Major/Specialization', 'getMajor',  0, null, null, 'label', '<xml><getter>getMajor</getter></xml>', 80, '0', null, 1, 11, '---', 0, 0),
    (117, 3, 'ohrm_emp_education.start_date', 'Start Date', 'getStartDate',  0, null, null, 'labelDate', '<xml><getter>getStartDate</getter></xml>', 80, '0', null, 1, 11, '---', 0, 0),
    (118, 3, 'ohrm_emp_education.end_date', 'End Date', 'getEndDate',  0, null, null, 'labelDate', '<xml><getter>getEndDate</getter></xml>', 80, '0', null, 1, 11, '---', 0, 0),
    (119, 3, 'ohrm_emp_license.license_no', 'License Number', 'getLicenseNo',  0, null, null, 'label', '<xml><getter>getLicenseNo</getter></xml>', 200, '0', null, 1, 14, '---', 0, 0),
    (120, 3, 'ohrm_emp_termination.note', 'Termination Note', 'getNote',  0, null, null, 'label', '<xml><getter>getNote</getter></xml>', 100, '0', null, 1, 6, '---', 0, 0);
...
DECLARE @admin_user_role_id int;
SET @admin_user_role_id = (SELECT TOP 1 id FROM ohrm_user_role WHERE name = 'Admin' );
DECLARE @ess_user_role_id int;
SET @ess_user_role_id = (SELECT TOP 1 id FROM ohrm_user_role WHERE name = 'ESS');

DECLARE @admin_home_page int;
SET @admin_home_page = (SELECT TOP 1 id FROM ohrm_home_page WHERE user_role_id = @admin_user_role_id );
DECLARE @ess_home_page int;
SET @ess_home_page = (SELECT TOP 1 id FROM ohrm_home_page WHERE user_role_id = @ess_user_role_id );
...
DECLARE @dashboard_module int;
SET @dashboard_module = (SELECT TOP 1 id FROM ohrm_module WHERE name = 'dashboard');

DECLARE @dashboard_screen int;
INSERT INTO ohrm_screen (name, module_id, action_url) VALUES ('Dashboard', @dashboard_module, 'index');
SET @dashboard_screen = (SELECT TOP 1 id FROM ohrm_screen WHERE name = 'Dashboard');
...
DECLARE @ess_role_id int;
DECLARE @supervisor_role_id int;
...
DECLARE @save_kpi_screen_id int;
INSERT INTO ohrm_screen ([name], module_id, action_url) VALUES  
('Save KPI', @module_id, 'saveKpi');  
SET @save_kpi_screen_id = (SELECT SCOPE_IDENTITY());   

DECLARE @search_kpi_screen_id int;
INSERT INTO ohrm_screen ([name], module_id, action_url) VALUES  
...
DECLARE @admin_user_role int;
DECLARE @ess_user_role int;
...
DECLARE @performance_module_id int;
...
DECLARE @purge_employee_screen_id int;
DECLARE @purge_candidate_screen_id int;
DECLARE @access_employee_records_screen_id int;
...
DECLARE @parent_menu_id_level_2 int;
...
DECLARE @language_packages_screen_id int;
DECLARE @language_customization_screen_id int;
DECLARE @save_language_customization_screen_id int;
DECLARE @export_language_package_screen_id int;
