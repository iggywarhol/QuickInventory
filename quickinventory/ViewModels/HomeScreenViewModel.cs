...
namespace SimpleInventory.ViewModels
{
    class HomeScreenViewModel : BaseViewModel
    {
        ...
        public ICommand MoveToFreshDesk
        {
            get { return new RelayCommand(LoadFreshDesk); }
        }
        private void LoadFreshDesk()
        {
             PushViewModel(new FreshworksViewModel(ViewModelChanger) { CurrentUser = CurrentUser });
        }
